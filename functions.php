<?php
    ...
    if ( !function_exists( 'breadcrumb_trail' ) ) {
        require_once( get_template_directory() . '/framework/plugins/breadcrumb-trail/inc/breadcrumbs.php' );
    }
    
    require_once( get_template_directory() . '/framework/widgets/flickr-widget.php' );
    ...
    function retouch_get_font_url() {
         ...
         * own language.
         */
        $montserrat = _x( 'on', 'Montserrat font: on or off', 'twentythirteen' );
