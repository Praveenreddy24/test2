...
class Flickr_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'widget_flickr', 'description' => 'The most recent photos from flickr.');

		$control_ops = array('id_base' => 'flickr-widget');

		$this->WP_Widget('flickr-widget', 'ReTouch: Flickr', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" type="text" value="<?php echo $instance['title']; ?>" />
		</p>
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id('api'); ?>" name="<?php echo $this->get_field_name('api'); ?>" type="text" value="<?php echo $instance['api']; ?>" />
